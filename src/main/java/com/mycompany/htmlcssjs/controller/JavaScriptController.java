...
public class JavaScriptController {
  ...
  public String exam06DynamicFieldMethod() {
    ...
    @RequestMapping("/exam09_class") //객체가 만들어진 이후에 필드와메소드넣을수있다
    public String exam09Class() {
      log.info("exam09Class() 실행");
      return "javascript/exam09_class";
  }
    
    @RequestMapping("/exam10_static") //객체가 만들어진 이후에 필드와메소드넣을수있다
    public String exam10Static() {
      log.info("exam10Static() 실행");
      return "javascript/exam10_static";
    }
    
    @RequestMapping("/exam11_inheritance") //객체가 만들어진 이후에 필드와메소드넣을수있다
    public String exam11_inheritance() {
      log.info("exam11Inheritance() 실행");
      return "javascript/exam11_inheritance";
    }
    
    @RequestMapping("/exam12_desturcturing_assignment") //객체가 만들어진 이후에 필드와메소드넣을수있다
    public String exam12DestructuringAssignment() {
      log.info("exam12DestructuringAssignment() 실행");
      return "javascript/exam12_desturcturing_assignment";
    }

    @RequestMapping("/exam13_string") //객체가 만들어진 이후에 필드와메소드넣을수있다
    ...
    public String exam18Regxp() {
      log.info("exam18Regxp() 실행");
